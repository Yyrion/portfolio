...
function Home() {
  ...
  const projectlist = [{
    ...
    title:"The Clock is Running", link:"theclockisrunning", shortresume:"None", image:"../../backgroundpoly.webp"
}
]
  ...
  return (
    <div className="bg-[url(../../backgroundpoly.webp)] bg-cover bg-center lg:bg-fixed xl:bg-fixed">
      <NavMenu center={centerElement} />
        ...
        <main className='pt-20 flex flex-col pb-10'>

{/*Accueil*/}
          <section tabIndex='0' id='accueil' className='place-self-center shadow-lg lg:w-min lg:place-items-center lg:px-32 opacity-95 flex flex-wrap justify-center lg:flex-nowrap sm:flex-col md:flex-col lg:flex-row bg-zinc-100 text-zinc-800 rounded-md m-20 lg:mt-20 lg:mb-30 lg:mx-40 p-3'>
          ...
          <HashLink tabIndex='0' smooth to='/#presentation' scroll={(element) => element.scrollIntoView({ behavior: 'smooth', block: 'center' })} className='animate-bounce text-7xl justify-center place-self-center'><HiChevronDoubleDown /></HashLink>

{/*Présentation*/}
          <div tabIndex='0' className="text-white flex flex-col lg:flex-row outline-2 outline outline-zinc-700 lg:h-128 h-min w-full bg-zinc-800 shadow-md mt-52 mb-20 lg:mt-52 lg:px-32 py-5 h-min">
            <section id="presentation" className="text-black p-2 lg:p-4 bg-white flex flex-row lg:w-2/3 lg:rounded-md outline outline-2 outline-zinc-800 h-full">
              ...
              <div className="p-4 pl-8 h-full lg:w-2/3">
                ...
                <div className='inline-flex space-x-16 text-6xl place-self-end pt-4'>
                  <a tabIndex='0' href='https://github.com/Yyrion' target='_blank'>
                    <FaGithub />
                  </a>
                  <a tabIndex='0' href='https://www.linkedin.com/in/ewen-rondin-32ba3432b' target='_blank'>
                    <FaLinkedin />
                  </a>
                </div>
              </div>
            ...
            {/* Section Skills */}
            <section  tabIndex='0'id="skills" className='flex flex-col h-full w-full p-4 lg:p-0 lg:w-1/3 lg:ml-16'>
...
{/*Projets*/}
          ...
          <section tabIndex='0' id="projects" className="-z-10 outline outline-2 outline-zinc-700 flex justify-center px-8 my-48 py-10 bg-zinc-100 w-full z-10 h-48 opacity-95">
...
{/*Contact*/}
          <section tabIndex='0' id='contact' className='place-self-center outline outline-4 outline-white opacity-95 bg-zinc-800 mx-5 lg:mx-20 my-20 lg:w-1/2 text-zinc-800 rounded-md py-7 px-3 outline outline-1 outline-zinc-700'>
            ...
            <form name="contact" method="post" className='bg-zinc-800 text-white rounded-lg py-3 px-5 outlineoutline-white mt-3'>
              ...
              <p>
                <label>Votre email : 
                  <input tabIndex='0' type="email" name="email"
              ...
              <p>
                <label>Votre message : 
                  <textarea tabIndex='0' name="message"
